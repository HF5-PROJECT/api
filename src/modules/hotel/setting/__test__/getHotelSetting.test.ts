...
describe("GET /api/hotel/setting/:id", () => {
    ...
    beforeEach(async () => {
        ...
        ({ accessToken, accessTokenNoPermission } = await addTestUserAndPermission(fastify, 'HotelSetting Get'));
    ...
    it("should return status 200 and get hotelSetting by id", async () => {
