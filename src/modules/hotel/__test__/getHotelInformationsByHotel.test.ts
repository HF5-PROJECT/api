...
describe("GET /api/hotel/:id/information", () => {
    ...
    it("should return status 200 and get all hotelInformations", async () => {
        const response = await fastify.inject({
            method: "GET",
            url: "/api/hotel/1000/information",
        });
    ...
    it("should return status 400 and return error, if no hotel were found", async () => {
        const response = await fastify.inject({
            method: "GET",
            url: "/api/hotel/1003/information",
        });
